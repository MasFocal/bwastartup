...
func (h *campaignHandler) GetCampaigns(c *gin.Context) {
	...
	if err != nil {
		response := helper.APIResponse("Erorr to get campaigns", http.StatusBadRequest, "error", nil)
...
func (h *campaignHandler) GetCampaign(c *gin.Context) {
	...
	if err != nil {
		response := helper.APIResponse("Failed to get detail of campign", http.StatusBadRequest, "error", nil)
		c.JSON(http.StatusBadRequest, response)
		return
	}
...
func (h *campaignHandler) UpdateCampaign(c *gin.Context) {
	...
	if err != nil {
		response := helper.APIResponse("Failed to update campign", http.StatusBadRequest, "error", nil)
		c.JSON(http.StatusBadRequest, response)
		return
	}
